...
|----|---------|---------|--------|-------|
| SPEC-001 | conversiones | `.github/specs/conversiones.spec.md` | DRAFT | 2026-03-13 |
| SPEC-002 | front-pom-page-factory | `.github/specs/front-pom-page-factory.spec.md` | IN_PROGRESS | 2026-03-16 |
...
|---------------|---------|--------|
| Flujo 1 Front-End con POM + Page Factory | `.github/requirements/front-pom-page-factory.md` | `/generate-spec front-pom-page-factory` |
